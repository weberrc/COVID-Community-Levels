...
tele <- read.csv("Teletracker/2022-08-10 HHSProtect Teletracker.csv") %>% 
  select(entry_date,
  ...
  filter(entry_date >= "2022-08-03",
         entry_date <= "2022-08-09") %>% 
...
hsa <- read.csv("Teletracker/2022-08-10 HHSProtect Teletracker.csv") %>% 
  select(entry_date,
         admits_last_24_hrs_covid_admissions_confirmed_adult,
         admits_last_24_hrs_covid_admissions_confirmed_pediatric,
         hospital_county) %>% 
...
co_rate <- read.csv("Teletracker/2022-08-10 HHSProtect Teletracker.csv") %>% 
  select(entry_date,
         admits_last_24_hrs_covid_admissions_confirmed_adult,
         admits_last_24_hrs_covid_admissions_confirmed_pediatric) %>% 
  mutate(entry_date = ymd(entry_date)) %>% 
